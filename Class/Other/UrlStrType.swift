...
enum UrlStrType {
    ...
    case mapData//获取地图上的数据 //附近商家地图上数据
    case payHelp//支付帮助
    ...
    ///根据参数获取推荐列表数据
    static func urlStringWithRecommentStr(_ offset: Int64) -> String {
    ...
    ///根据参数获取商家列表数据
    static func urlStringWithMerchantStr(_ kindID: Int64, offset: Int64) -> String {
        ...
        let latitudeStr = "\(appdelegate.latitude)"
        let longitudeStr = "\(appdelegate.longitude)"
        let offsetStr = "\(offset)"
        let urlStr = str1 + latitudeStr + "%2C" + longitudeStr + "&offset=" + offsetStr + str2
        
        return urlStr
    }
    
    ///根据参数折扣网页数据
    static func urlStringWithDiscountWebData(_ urlString: String) -> String {
    ...
    ///根据参数订单详情
    static func urlStringWithShopDetailData(_ str: String) -> String {
    ...
    ///根据参数 看了本店还看了其他的数据
    static func urlStringWithOtherRecommendShop(_ shopID: String) -> String {
    ...
    ///根据参数获取商家详情
    static func urlStringWithMerchantDetail(_ poiid: String) -> String {
    ...
    ///根据参数获取附近团购
    static func urlStringWithMerchantAroundGroupPurchaseData(_ poiid: String) -> String {
    ...
    static func urlWith(_ type: UrlStrType) -> URL {
